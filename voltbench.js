...
function solve(){
  ...
  if(changed && typeof console!=='undefined') console.warn('voltbench: solver did not converge after 12 iterations (oscillating circuit?)');
...
$('#btnAI').onclick=()=>{ const msg=`AI EXTRACT (hybrid workflow)\n\n`+
  ...
  `2. Send that same image to Aki in chat and say: "extract this panel to Voltbench JSON".\n`+
...
/* =========================================================================
   VOLTBENCH — EXTRAS (features 1-13). All top-level fn decls hoist.
   ========================================================================= */
...
/* =========================================================================
   VOLTBENCH — EXTRAS2 (features 14-25). All top-level fn decls hoist.
   ========================================================================= */
...
/* =========================================================================
   VOLTBENCH — EXTRAS3 (features 26-37). fn decls hoist; state via var.
   ========================================================================= */
...
/* =========================================================================
   VOLTBENCH — EXTRAS4 (features 38-49). fn decls hoist; state via var.
   ========================================================================= */
...
function scanQR(){ if(typeof BarcodeDetector==='undefined'){ openModal('QR scan','<div class="hint">This browser has no built-in QR scanner (needs Chrome/Edge on Android or a recent desktop). Use \ud83d\udd17 Copy share link instead.</div>'); return; }
  openModal('Scan a panel QR','<video id="qr-vid" playsinline style="width:100%;border-radius:8px;background:#000"></video><div class="hint" style="margin-top:6px">Point the camera at a Voltbench QR code.</div>');
